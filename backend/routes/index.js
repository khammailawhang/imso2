...
router.use('/feechart', require('./feechart'));
router.use('/admin', require('./admin'));
// For Report 
// router.use('/feeperday', require('./feeperday'));
// router.use('/feepermonth', require('./feepermonth'));
// router.use('/feeperyear', require('./feeperyear'));
// router.use('/feeperyear_total', require('./feeperyear_total'));
// router.use("/modelpopular", require("./modelpopular"));
router.use("/income", require("./income"));
router.use("/car", require("./car"));
router.use("/indexpdf", require("./indexpdf"));
router.use("/indexpdfe", require("./indexpdfe"));
// router.use("/admin", require("./admin"));
