            ...
            <v-card flat color="white">
              ...
              <v-card-text id="print">
                <table
                  align="center"
                  justify="center"
                  style="font-size: 20px; font-family:Vision,Phetsarath OT; width:90%"
                >
                  <br />
                  <br />
                  <br />
                  <tr colspan="12" align="center">
                    <th class="fontsize">
                      <img src="../assets/PWT.png" align="left" width="80px" /> ລາຍງານຜົນກວດກາສະພາດລົດ
                    </th>
                  </tr>
                </table>
                ...
                <table
                  align="center"
                  justify="center"
                  style="font-size: 16px; font-family:Vision,Phetsarath OT; width:90%"
                >
                ...
                <table
                  align="center"
                  justify="center"
                  style="font-size: 18px; font-family:Vision,Phetsarath OT; width:90%"
                >
                  <tr colspan="12">
                    <td align="center">
                      ໝາຍເລກທະບຽນ:
                      <b class="pl-2" v-text="TRName"></b>
                      <b class="pl-4" v-text="platc_no"></b>
                    </td>
...
ມູມ .. ອ່ຽງ .. ຄວາມສະຫວ່າງ kcd
                      ...
                      <td class="td">
                        ມູມຕົກບໍ່ເກີນ -0.29 ອົງສາແລະບໍ່ຕໍ່າກວ່າ -2.29 ອົງສາ
                        <br />(ມີມູມກົດຈາກແນວລະດັບຫຼາຍກວ່າ0.29ອົງສາແຕ່ບໍ່ເກີນ2.29ອົງສາ)
                        <br />ບໍ່ອ່ຽງທາງຂວາ(-ອ່ຽງຊາຍ/+ອ່ຽງຂວາ)
                        <br />
...
ມູມ .. ອ່ຽງ .. ຄວາມສະຫວ່າງ kcd
                      ...
                      <td class="td">
                        ມູມຕົກບໍ່ສູງກວ່າແນວຂະໜານກັບພື້ນພຽງ
                        <br />ບໍ່ອ່ຽງທາງຂວາ(-ອ່ຽງຊາຍ/+ອ່ຽງຂວາ)
                        <br />
...
ເພົາທີ 4
                      ...
                      <td class="td">
                        ປະສິດທີພາບລວາມ
                        <b class="pl-2" v-text="BSUM"></b> %
                        <br />ແຮງເບຣກ ລໍ້ໍໍຊາຍ
                        <b class="pl-2" v-text="LFF"></b> % , ລໍ້ຂວາ
                        <b class="pl-2" v-text="RFF"></b> % , ບໍ່ສົມດູນ
                        <b class="pl-2" v-text="RF"></b> %
                        <br />ແຮງເບຣກ ລໍ້ໍໍຊາຍ
                        <b class="pl-2" v-text="LRR"></b> % , ລໍ້ຂວາ
                        <b class="pl-2" v-text="RRR"></b> % , ບໍ່ສົມດູນ
                        <b class="pl-2" v-text="RR"></b> %
                        <br />ແຮງເບຣກ ລໍ້ໍໍຊາຍ
                        <b class="pl-2" v-text="LRM"></b> % , ລໍ້ຂວາ
                        <b class="pl-2" v-text="RRM"></b> % , ບໍ່ສົມດູນ
                        <b class="pl-2" v-text="RM"></b> %
                        <br />ແຮງເບຣກ ລໍ້ໍໍຊາຍ
                        <b class="pl-2" v-text="LRF"></b> % , ລໍ້ຂວາ
                        <b class="pl-2" v-text="RRF"></b> % , ບໍ່ສົມດູນ
                        <b class="pl-2" v-text="PB"></b> %
                      </td>
                      <td class="td" align="center">
                        <v-text
                          class="mt-1"
                      ...
                      <td class="td">
                        ບໍ່ນ້ອຍກ່ວາ 50% ຂອງນໍ້າໜັກລົດ
                        <br />ຜົນຕ່າງຄວາມສົນດູນລະຫວາງແຮງເບຣກລໍ້ຊາຍກັບລໍ້ຂວາຕ້ອງບໍ່ເກີນ
                        <br />25% ຂອງແຮງເບຣກສູງສຸດຂອງເພົານັ້ນ
                      </td>
                    </tr>
                    <tr class="tr">
                    ...
                    <tr class="tr">
                      ...
                      <td class="td">
                        ຜົນການກວດທີ່ 20 km/h ..... ຜົນທີ່ໄດ້ ... %
                        <br />ຜົນການກວດທີ່ 40 km/h ..... ຜົນທີ່ໄດ້ ... %
                        <br />ຜົນການກວດທີ່ 60 km/h ..... ຜົນທີ່ໄດ້ ... %
                        <br />
                      </td>
                      <td class="td" align="center">
                        <v-text
                      ...
                      <td class="td">
                        <br />ຄ່າຄາດເຄື່ອນບໍ່ເກີນຮ້ອຍລະ 10
                      </td>
                    </tr>
                    <tr class="tr">
                    ...
                    <tr class="tr">
                      ...
                      <th
                        colspan="3"
                      >ເພົາ 1 = ....... kg, ເພົາ 2 = ...... kg, ເພົາ 3 = ...... kg, ເພົາ 4 = ...... kg, ລວມ = ...... kg</th>
                    </tr>
                  </tbody>
                </table>
                ...
                <table
                  align="center"
                  justify="center"
                  style="font-size: 13px; font-family:Vision,Phetsarath OT; width:90%"
                >
                  <tr colspan="10">
                    <b>
                      <td class="pl-12" style="font-size: 18px;">
                        ສະຫຼຸບຜົນການກວດສະພາບ ແລະ ຂໍ້ບົກຜ່ອງ:
                        <b>
                          <v-text
                            ...
                            v-if="brk_m === 'true' &&
                                            ...
                                            "
                          >ຜ່ານ</v-text>
                          <v-text class="ma-1" x-small tile color="black" v-else>ບໍ່ຜ່ານ</v-text>
                        </b>
                      </td>
                    </b>

                    <td align="right">
                      <img :src="photo" aspect-ratio="1.7" contain width="150px" height="130px" />
                    </td>
...
export default {
  ...
  data: () => ({
    ...
    base64: "",
    file: "",
    qrUrl: "http://178.128.23.172/la/Inspectionqr2?inspection_id="
  }),
