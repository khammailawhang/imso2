...
<v-layout row wrap>
    ...
    <!-- <v-col cols="12" xl="2" lg="3" md="4" sm="4">
        <v-menu ref="show_start_date" v-model="show_start_date" item-text="created_at" :return-value.sync="startdateFiltervalue" persistent width="290px">

            <template v-slot:activator="{ on }">
                <v-text-field item-text="created_at" v-model="show_start_date" label="ເລືອກວັນທີເລີມຕົ້ນ" prepend-icon="event" readonly v-on="on"></v-text-field>
            </template>
  ...
  <v-col cols="12" xl="2" lg="3" md="4" sm="4">
        ...
        <v-menu ref="show_start_date" :close-on-content-click="false" v-model="show_start_date" :nudge-right="40" :return-value.sync="start_date" lazy transition="scale-transition" offset-y full-width min-width="290px">
            <template v-slot:activator="{ on }">
                <v-text-field slot="activator" v-on="on" v-model="start_date" label="From" prepend-icon="event" readonly></v-text-field>
            </template>
    ...
    <v-col cols="12" xl="2" lg="3" md="4" sm="4">
        <v-menu ref="show_end_date" :close-on-content-click="false" v-model="show_end_date" :nudge-right="40" :return-value.sync="end_date" lazy transition="scale-transition" offset-y full-width min-width="290px">
              <template v-slot:activator="{ on }">
            <v-text-field slot="activator" v-on="on" v-model="end_date" label="To" prepend-icon="event" readonly></v-text-field>
            </template>
