...
export default {
  ...
  methods: {
    ...
    initialize() {
      this.axios
        .get("/api/report/all/branch_id/" + this.$route.query.branch_id)
        .then(response => {
