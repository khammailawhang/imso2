...
<div class="start">
    <v-col cols="12" xl="12" lg="8" md="12" sm="12">
        <v-card-title>
            <v-row>
                <v-col cols="12" lg="3">
                    <v-select :items="registers" class="mr-4" item-text="PName" label="Province" v-model="provinceFilterValue"></v-select>
                </v-col>
                <v-col cols="12" lg="3">
                ...
                <v-col cols="12" lg="3">
                    <v-menu ref="show_start_date" :close-on-content-click="false" v-model="show_date" :nudge-right="40" :return-value.sync="show_start_date" lazy transition="scale-transition" offset-y full-width min-width="290px">
                        ...
                        <v-date-picker v-model="date"  @input="filterStartDate"></v-date-picker>
