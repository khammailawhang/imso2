                            ...
                            <v-card-title>
                                ...
                                <v-btn-toggle dense rounded>
                                    ...
                                    <v-btn depressed color="#3d5AFE" dark v-on="on" width="80px" class="white--text text-capitalize">
                                        <download-csv :data="inspections" name="All_Inspection_Expired.csv">{{$t("Report.Download")}}</download-csv>
                                    </v-btn>
                                </v-btn-toggle>
                            </v-card-title>
                            <v-card-subtitle>
                                <v-row>
                                    ...
                                    <v-col cols="12" xl="2" lg="2" md="4" sm="4">
                                        <v-select :items="inspections" item-text="ແຂວງ" :label="$t('Province.Name')" dense color="#3d5AFE" v-model="provinceFilterValue"></v-select>
                                    </v-col>
                                    <v-col cols="12" xl="2" lg="2" md="4" sm="4">
                                        <v-select :items="inspections" item-text="ປະເພດ" :label="$t('Inspection.inspectonseach')" dense color="#3d5AFE" v-model="typeplactnoFilterValue"></v-select>
                                    </v-col>
                                    <v-col cols="12" xl="2" lg="2" md="4" sm="4">
...
export default {
    ...
    methods: {
        ...
        initialize() {
            this.axios
                .get("/api/report/admin/inspection/expired")
                .then(response => {
