                            ...
                            <v-card-title>
                                ...
                                <v-btn-toggle dense rounded>
                                    ...
                                    <v-btn depressed color="#3D5AFE" dark v-on="on" width="80px" class="white--text text-capitalize">
                                        <download-csv :data="fees" name="All_Expense_Software.csv">{{$t("Report.Download")}}</download-csv>
                                    </v-btn>
                                </v-btn-toggle>
                            </v-card-title>
                            <v-card-subtitle>
                                <v-row>
                                    ...
                                    <v-col cols="12" xl="2" lg="2" md="4" sm="4">
                                        <v-select :items="fees" item-text="ແຂວງ" :label="$t('Province.Name')" dense color="#3D5AFE" v-model="provinceFilterValue"></v-select>
                                    </v-col>
                                    <v-col cols="12" xl="2" lg="2" md="4" sm="4">
                                        <v-select :items="fees" item-text="ປະເພດ" :label="$t('Inspection.inspectonseach')" dense color="#3D5AFE" v-model="typeplactnoFilterValue"></v-select>
                                    </v-col>
                                    <v-col cols="12" xl="2" lg="2" md="4" sm="4">
