  ...
  <v-app>
    <v-content>
      <v-container>
        ...
        <p>Note: fixed columns and grouping tables below are added only in <a target="_blank" href="https://github.com/lzhoucs/vuetify">my vuetify folk</a>, which is published on <a target="_blank" href="https://www.npmjs.com/package/@lzhoucs/vuetify">npm</a>. Also checkout <a target="_blank" href="https://codepen.io/lzhoucs/pen/dqZvXr">fixed columns table demo</a></p>
